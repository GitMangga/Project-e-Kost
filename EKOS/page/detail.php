...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			<table class="table table-hover">
				<?php $query = $connection->query("SELECT a.nama, b.nama AS pemilik, a.alamat, a.tersedia, a.status, a.harga_3bulan, a.harga_6bulan, a.harga_pertahun, a.fasilitas, a.pengunjung FROM kost a JOIN pemilik b USING(id_pemilik) WHERE id_kost=$_GET[key]");
	...
	<div class="row">
		<?php $query = $connection->query("SELECT judul, file FROM galeri WHERE id_kost=$_GET[key]");
		while ($row = @$query->fetch_assoc()) : ?>
